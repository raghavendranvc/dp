    ...
    public int solve(ArrayList<String> A) {
        ...
        while(maxRotatedStrong < originalStrings.size()) {
            ...
            for (int i = 0; i < originalStrings.size(); i++) {
                ...
                System.out.println("String["+i+"]="+A.get(i)+" rotatedString "+rotatedString+" after "+rotate+" rotations" );
                if(rotatedString.equals(originalStrings.get(i))){
                    countSameStrings++;
                    maxRotatedStrong = Math.max(maxRotatedStrong, countSameStrings);
                    System.out.println("countSameStrings="+countSameStrings+" maxRotatedStrong="+maxRotatedStrong );
                }
