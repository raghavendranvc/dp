...
public class MaxDistance {
	...
	/*
	 * public void mergeSort(int[] array){ mergeSort(array,0,array.length-1); }
	 * 
	 * public void mergeSort(int[] array, int l, int r){
	 * 
	 * if(l<r) {
	 * 
	 * int middle = (l + r) / 2; mergeSort(array, l, middle); mergeSort(array,
	 * middle + 1, r); merge(array, l, middle, r); } }
	 * 
	 * public void merge(int[] array, int l, int m, int r){
	 * 
	 * int[] leftArray = new int[m-l+1]; int k =0; for(int i=l;i<=m;i++){
	 * leftArray[k++] = array[i]; }
	 * 
	 * int[] rightArray = new int[r-m]; k =0; for(int i=m;i<=r;i++){ rightArray[k++]
	 * = array[i]; }
	 * 
	 * int i=0, j=0, t=l;
	 * 
	 * while (i<leftArray.length && j<rightArray.length) { if(leftArray[i] <=
	 * rightArray[j]){ array[t++] = leftArray[i++]; } else { array[t++] =
	 * rightArray[j++]; } }
	 * 
	 * while (i<leftArray.length){ array[t++] = leftArray[i++]; }
	 * 
	 * while (i<rightArray.length){ array[t++] = rightArray[j++]; } }
	 */
