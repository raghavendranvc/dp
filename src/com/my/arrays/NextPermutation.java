...
public class NextPermutation {
    ...
    public ArrayList<Integer> nextPermutation(ArrayList<Integer> A) {
        ...
        // finds the first integer 'i' such that thereafter everything is decreasing order
        ...
        // Within the decreasing sequence, find the last digit which is greater than the one at 'decreasingSequenceEnd'
