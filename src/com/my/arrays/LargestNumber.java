...
public class LargestNumber {
	...
	public String largestNumberCopied(final List<Integer> a) {
	...
	public String largestNumber(final List<Integer> A) {
		...
		/*
		 * 
		 * Arrays.sort(arr, new Comparator<String>(){ public int compare(String a,
		 * String b){ return (b+a).compareTo(a+b); } });
		 * 
		 * 
		 */
