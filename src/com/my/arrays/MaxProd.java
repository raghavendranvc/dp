...
public class MaxProd {
	...
	public int maxSpecialProduct(ArrayList<Integer> A) {
		...
		// storing the max element so far from left

		// We need to find the first greater element towards left and right and find
		// their product
	...
	public int maxSpecialProduct1(ArrayList<Integer> A) {
		...
		Deque<Integer> q = new ArrayDeque<>(); // Using like a Stack
		q.addLast(0);
	...
	private ArrayList<Integer> leftSpecial(ArrayList<Integer> A) {
	...
	private ArrayList<Integer> rightSpecial(ArrayList<Integer> A) {
	...
	public int maxSpecialProduct3(ArrayList<Integer> A) {
		ArrayList<Integer> l = leftSpecial(A);
		ArrayList<Integer> r = rightSpecial(A);
	...
	public static void main(String[] args) {
		...
		int[] a = new int[] { 523, 4241, 1053, 7816, 5181, 1293, 7152, 6053, 4974, 4678, 418, 7627, 2466, 6262, 2740,
				850, 5008, 7720, 2431, 377, 7826, 3582, 8328, 8660, 3498, 1194, 8226, 4830, 8823, 1349, 2554, 880, 9469,
				6228, 7425, 6432, 4278, 6407, 501, 1273, 1602, 3931, 699, 9078, 4550, 7295, 7128, 3653, 60, 9578, 4671,
				8152, 7225, 7085, 5021, 5016, 5220, 4178, 8696, 6896, 5665, 5601, 5119, 5118, 3724, 1618, 3755, 9569,
				8588, 4576, 4914, 8123, 4158, 717, 583, 143, 963, 8009, 8441, 7306, 1171, 7407, 5202, 8720, 1621, 2963,
				318, 7136, 1753, 895, 3236, 4611, 832, 4364, 1852, 3848, 5452, 1111, 5550, 9448, 6235, 1749, 9224, 8089,
				6772, 933, 8960, 7257, 5346, 4703, 9724, 2890, 1820, 7495, 4887, 7108, 7393, 2501, 4947, 5402, 9366,
				2745, 2757, 4475, 7918 };
