...
public class MaxNonNagativeArray {
	...
	public ArrayList<Integer> maxset(ArrayList<Integer> A) {
		...
		System.out.println("start: maxArraySizeIndex=" + maxArraySizeIndex + " maxSubArraySum=" + maxSubArraySum
				+ " maxArraySizeIndex=" + maxArraySizeIndex);
		...
		for (int i = 1; i < subArrayIndex; i++) {
			...
			if (newSubArraySum > maxSubArraySum) {
				...
				System.out.println("maxArraySizeIndex=" + maxArraySizeIndex + " maxSubArraySum=" + maxSubArraySum
						+ " maxArraySizeIndex=" + maxArraySizeIndex);
			}
		}
