...
public class KthSmallest {
    ...
    public int kthsmallestBruteForce(final List<Integer> A, int B) {
        ...
        for(int i=0;i<A.size();i++){
            ...
            System.out.println("Element="+A.get(i)+" equalElements="+equalElements+" smallerElements="+smallerElements);
    ...
    private final int partition(final List<Integer> A, int left, int right){
        ...
        /**
         * A[right] is considered pivot element
         * Move all elements which are less than pivot to the left
         * At the end 'i' should point to the first element greater than pivot
         *
         * the pivot is placed in the ith position
