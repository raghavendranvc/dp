...
public class PointsOnLine {
    ...
    static class Slope {
        ...
        public boolean equals(Object o) {
            ...
            if (yDiff != slope.yDiff) return false;
    ...
    public int maxPoints(ArrayList<Integer> a, ArrayList<Integer> b) {
        ...
        for(int i=0;i<n;i++){
            ...
            System.out.println("samePoint="+samePoint+" sameVerticalLine="+sameVerticalLine+" sameSlopeMax="+sameSlopeMax);
    ...
    public static void main(String[] args){
        ...
        /*int[] a = {-6,      5,      -18,    2,      5,      -2};
        int[] b = {-17,     16,      -17,    -4,     -13,    20};*/

        /*int[] a = {-2,  -9,     4,   -7,    5,      10,     1};
        int[] b = {-17, -19,  -12,   -15,   -3,     11,     4};*/
