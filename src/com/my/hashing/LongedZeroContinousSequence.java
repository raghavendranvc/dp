...
public class LongedZeroContinousSequence {
	 ...
	 * 
		1) build up cumulative sum table
		2) Check whether there is already a sum exists
		3) if yes then calculate lenght and see if its largest
		
		we could have done this serially first by calculating
		the cumulative sums in an array.
