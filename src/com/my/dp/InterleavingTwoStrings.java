...
public class InterleavingTwoStrings {
	...
	public boolean isInterleavedIter(String a,String b,String c){
		...
		/*
		 * Base condition. When String A is empty. Then String B should match String C. First Row (row=0)
		 * The value will be true till the characters of strings (b,c) matches. Thereafter it will be false.
		 */
		for(int j=1;j<=n;j++){
		...
		/*
		 * Base condition. When String B is empty. Then String A should match String C. First Column (column=0)
		 * 
		 */
