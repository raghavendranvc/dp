...
public class HotelReviews {
    ...
    static class Review implements Comparable{
        int goodWords;
        int index;

        public Review(int index,int goodWords){
            this.index = index;
        ...
        public int compareTo(Object o) {
            ...
            if(this.goodWords > other.goodWords){
                return -1;
            } else {
                return 1;
            }
        ...
        public String toString(){
            return "index="+index+" goodWords="+goodWords;
        }
    }

    public ArrayList<Integer> solve(String A, ArrayList<String> B) {
        Set<String> goodWords = new HashSet(getWords(A));
        Set<Review> treeSet = new TreeSet<>();

        for(int i=0;i<B.size();i++) {
            String str = B.get(i);
            List<String> allWords = getWords(str);
            allWords.retainAll(goodWords);
            int rank = allWords.size();
            treeSet.add(new Review(i,rank));
            System.out.println("str="+str+" Review summary="+new Review(i,rank));
        }
        System.out.println("returnList="+treeSet);

        Iterator<Review> iterator = treeSet.iterator();
        ArrayList<Integer> returnList = new ArrayList<>();
        while(iterator.hasNext()){
            returnList.add(iterator.next().index);
        }
