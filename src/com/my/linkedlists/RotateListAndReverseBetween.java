...
public class RotateListAndReverseBetween {
	...
	public ListNode reverseBetween(ListNode A, int B, int C) {
		 ...
		 */
		// For this, don't touch C and B. Here both B and C are reduced. B is reduced to
		// 0
	...
	public static void main(String[] args) {
		...
		RotateListAndReverseBetween rotateList = new RotateListAndReverseBetween();
	...
	public ListNode rotateRightLeetCode(ListNode head, int k) {
		if (head == null || head.next == null || k == 0) {
			return head;
		}
		int l = getLength(head);
		return rotateRightByK(head, k % l);
	}
	...
	private ListNode rotateRightByK(ListNode head, int k) {
